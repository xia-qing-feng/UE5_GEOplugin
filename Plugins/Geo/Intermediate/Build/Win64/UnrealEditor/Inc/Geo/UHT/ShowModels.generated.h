...
enum class EUpdateStatus : int32;
struct FKey;
...
#define FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_36_RPC_WRAPPERS_NO_PURE_DECLS \
	DECLARE_FUNCTION(execChamferMesh); \
	DECLARE_FUNCTION(execSubdivideMesh); \
...
#define FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_36_INCLASS_NO_PURE_DECLS \
private: \
...
#define FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_36_ENHANCED_CONSTRUCTORS \
private: \
...
#define FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_33_PROLOG
#define FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_36_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_36_RPC_WRAPPERS_NO_PURE_DECLS \
	FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_36_INCLASS_NO_PURE_DECLS \
	FID_UE_Projects_QFGeo_Plugins_Geo_Source_Geo_Public_ShowModels_h_36_ENHANCED_CONSTRUCTORS \
private: \
...
#define FOREACH_ENUM_EUPDATESTATUS(op) \
	op(EUpdateStatus::create) \
	op(EUpdateStatus::change) \
	op(EUpdateStatus::tmp) 

enum class EUpdateStatus;
template<> struct TIsUEnumClass<EUpdateStatus> { enum { Value = true }; };
